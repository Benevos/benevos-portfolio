...
function Education() {
     return (
        <div className='w-full flex flex-wrap gap-2 py-2 justify-center overflow-y-auto'>
            <Link title='Universidad Autónoma de Tamaulipas' href={'https://www.uat.edu.mx/'}
                className='flex w-fit bg-[#e96d18] rounded-full overflow-hidden education-shadow hover:brightness-110'>
                ...
                <div className='flex justify-center items-center overflow-x-hidden px-2 pr-4'>
                    <label className='font-semibold whitespace-nowrap pointer-events-none move text-white
                        ...
                        UAT | Ingeniero en sistemas
                    </label>
                </div>
            </Link>

            <Link title='Colegio Nacional de Educación Profesional Técnica' href={'https://conalep.edu.mx/'}
                className='flex w-fit bg-[#047c64] rounded-full overflow-hidden education-shadow hover:brightness-110'>
                ...
                <div className='flex justify-center items-center overflow-x-hidden px-2 pr-4'>
                    <label className='font-semibold whitespace-nowrap pointer-events-none move text-white
                                    min-[670px]:animate-none'>
                        Conalep | Técnico en Informatica
                    </label>
                </div>
            </Link>
        </div>
